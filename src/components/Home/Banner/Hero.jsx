...
const Hero = () => {
  return (
    <div>
       {/* bg-linear-to-t to-50% from-green-800 to-black min-h-screen */}
      <div
       ...
       className='min-h-screen bg-cover bg-center bg-no-repeat'>
        ...
        <div className=' lg:pt-18'>
          ...
          {/* left image */}
          {/* <div>
            <img className='float-animation ' src="/public/left.png" alt="" />
          </div> */}
          ...
          <div className=' text-center'>
            ...
            <h1 className='text-white lg:block md:block hidden border mt-5 md:mx-auto md:w-105 w-90 rounded-full py-2 border-green-700 text-center'>🏳️‍⚧️🏳️‍🌈🏳️‍⚧️🏳️‍🌈 Designig across 8+ countries 🏳️‍⚧️🏳️‍🌈🏳️‍⚧️🏳️‍🌈</h1>
            ...
            <div className='max-w-7xl mx-auto w-90 pt-20'>
          ...
          {/* Right image */}
          {/* <div className=''>
            <img className='float-animation  ' src="/right.png" alt="" />
          </div> */}
